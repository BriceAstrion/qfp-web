        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="w-full mt-8">
                <div className="flex p-8 max-w-7xl mx-auto bg-white rounded-lg shadow-lg mt-8">
                        ...
                        {isSubmitted ? (
                            <div className="text-center">
                                ...
                                <p className="mt-4 text-gray-700">
                                    ...
                                    Please click on the button below if you want to send another request or if you have
                                    more questions.
                                </p>
                                <button
                                    ...
                                    <div>
                                        <>
                                            <div className="flex items-center mb-4">
                                                <img src={contactImage} alt="Contact Image" className="w-50 h-32 object-cover mr-4"/>
                                                <p className="text-sm leading-relaxed text-gray-600">
                                                    Please fill out the form and tell us in more
                                                    detail about your query, and we will get back to you as soon as
                                                    possible.
                                                </p>
                                            </div>
                                        </>
                                        ...
                                        <div className="space-y-4">
                                            <p><strong className="text-gray-600 mb-4">Support Team:</strong> +31 800 123
                                                456
                                            </p>
                                            <p><strong className="text-gray-600 mb-4">Sales Team:</strong> +31 612 345
                                                678
                                            </p>
                                            <p><strong className="text-gray-600 mb-4">Customer Service:</strong> +31 698
                                                765
                                                432
                                            </p>
                                        </div>
                    ...
                    {!isSubmitted && (
                        <div className="w-1/2 p-4">
                            {/* Right Column - Form Inputs - Progressive Bar */}
                            <div className="relative w-full bg-gray-200 h-1 mt-4 mb-6">
                                <div
                                    className="absolute top-0 left-0 bg-gradient-to-r from-blue-600 to-blue-800 h-2
        rounded-full transition-all duration-500"
                                ...
                                <div className="absolute top-[-10px] flex justify-between w-full px-4">
                                    ...
                                    <div className="relative text-center">
                                        <div
                                            className={`w-6 h-6 rounded-full flex items-center justify-center ${
                                                step >= 2 ? 'bg-blue-800' : 'bg-gray-300'
                                            }`}
                                        >
                            ...
                            {step === 1 && (
                                <div>
                                    <fieldset className="mb-8 mt-10 ml-8">
                                        <legend className="text-xl text-gray-600 font-semibold">Purpose of contact
                                        </legend>
                                        <div className="flex flex-col mt-2">
                                            <label className="flex items-center my-2 mt-3 mb-3">
                                                <input
                                                    type="radio"
                                            ...
                                            <label className="flex items-center my-2 mt-3 mb-3">
                                                <input
                                                    ...
                                                    checked={purpose === "product Inquiry"}
                                                    onChange={handleOptionChange}
                                                    className="mr-2"
                                                />
                                                Product Inquiry
                                    ...
                                    <button onClick={handleNext} className="bg-blue-500 text-white font-bold py-2 px-4 ml-8 rounded"> Next</button>
                                </div>
                            )}

                            {step === 2 && (
                                <div>
                                    <h2 className="text-xl font-semibold mt-10 mb-8 text-gray-600 ml-8">Contact Information</h2>
                                    <form>
                                        <div className="mb-4 mt-2 ml-8">
                                            <label className="block text-sm text-gray-600 font-medium mb-1">First name</label>
                                            <input
                                                type="text"
                                                value={firstName}
                                        ...
                                        <div className="mb-4 mt-2 ml-8">
                                            <label className="block text-sm text-gray-600 font-medium mb-1">Last name</label>
                                            <input
                                                type="text"
                                                value={lastName}
                                        ...
                                        <div className="mb-4 mt-2 ml-8">
                                            <label className="block text-sm text-gray-600 font-medium mb-1">Work e-mail</label>
                                            <input
                                                type="email"
                                                value={email}
